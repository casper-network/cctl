...
def get_path_to_account_private_key(account_type: AccountType, account_idx: int = None):
    return get_path_to_account_key(account_type, AssymetricKeyType.PRIVATE, account_idx)


def get_path_to_account_public_key(account_type: AccountType, account_idx: int = None):
    return get_path_to_account_key(account_type, AssymetricKeyType.PUBLIC, account_idx)


def get_path_to_account_directory(account_type: AccountType, account_idx: int = None) -> pathlib.Path:
...
def get_path_to_account_key_directory(account_type: AccountType, account_idx: int = None) -> pathlib.Path:
...
def get_path_to_account_key(account_type: AccountType, key_type: AssymetricKeyType, account_idx: int = None) -> pathlib.Path:
