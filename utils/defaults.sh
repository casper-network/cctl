...
declare CCTL_PATH_TO_CASPER_CLIENT=${CSPR_COMPILE_TARGET:-$_CCTL_PATH_TO_WORKING_DIR/casper-client-rs}

# Set path -> casper-node.
declare CCTL_PATH_TO_CASPER_NODE=${CSPR_COMPILE_TARGET:-$_CCTL_PATH_TO_WORKING_DIR/casper-node}
