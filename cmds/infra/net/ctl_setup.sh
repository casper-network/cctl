...
function _setup_node_binary_config()
{
    ...
    SCRIPT=(
        ...
        "cfg['binary_port_server']['allow_request_get_all_values']=True;"
        "cfg['binary_port_server']['allow_request_get_trie']=True;"
        "cfg['binary_port_server']['allow_request_speculative_exec']=True;"
        "cfg['binary_port_server']['enable_server']=True;"
