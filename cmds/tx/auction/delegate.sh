...
function _help() {
    ...
    COMMAND
    ----------------------------------------------------------------
    cctl-tx-auction-delegate

    DESCRIPTION
    ----------------------------------------------------------------
    Delegates token from a user account to a validator account.

    ARGS
    ----------------------------------------------------------------
    amount          Amount (motes) to delegate. Optional.
...
function _main()
{
    ...
    log_break
    log "dispatching auction tx -> delegate.wasm"
    log_break
